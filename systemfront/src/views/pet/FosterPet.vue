  ...
  <div class="middle">
    ...
    <el-form class="register_message" label-width="100px" ref="ruleformfosterpet" :model="ruleForm" :rules="rulesfosterpet">
        ...
        <div class="middle_left">
          ...
          <el-form-item label="宠物类型" prop="petype">
            <el-cascader
              ...
              :options="options"
              v-model="ruleForm.petype"
              @change="handleChange">
            </el-cascader>
          </el-form-item>
          <el-form-item label="宠物主人ID" prop="userid">
      ...
      <div class="middle_bottom">
        ...
        <div class="addition">
          <el-form-item class="left"  label="申请寄养">
      ...
      <div class="btn_bottom">
        <el-form-item>
          <el-button class="btn" size="small" type="primary" @click="onSubmitpet()">注册</el-button>
...
<style scoped>
  @import '../../../static/css/pet/fosterpet.css';
</style>
