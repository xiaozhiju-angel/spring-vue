<template>
  <div>
    <div style="padding: 0px;text-align: left;color: #409EFF;font-size:16px;font-style: italic;font-weight: lighter">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp亲爱的小伙伴们,
      欢迎来到宠物管理乐园,在这里你们看到的是他人发布的宠物弃养信息,展示了他们想要弃养的宠物信息和自己的联系方式及弃养原因,想要领养他人宠物的小伙伴们请快快联系他/她吧!</div>
    <el-container>
    ...
    <QueryAbandon  class="main" :headerList="headerList" :bodyInfoList="bodyInfoList"></QueryAbandon>
  </div>
</template>

<script>
  import QueryAbandon from "./QueryAbandon";
  export default {
    name: "myCare",
    data() {
      return {
        ...
        headerList: ",用户ID,领养类型,宠物姓名,宠物性别,宠物类型,用户姓名,用户电话,发布时间,操作",
        bodyInfoList: [],
      }
    },
    components: {
    ...
    methods: {
      ...
      searchUserInfo(){
        var _this = this;
        this.getRequest("/adopt/getabandonkey?info=" + this.keywords).then(resp=> {
