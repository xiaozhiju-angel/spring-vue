          ...
          <div class="middle_bottom">
            <div class="topaddition">
              <el-form-item class="left"  label="发布ID">
                <el-input class="info"  v-model="ruleForm.acceptid"  size="mini" clearable disabled></el-input>
              </el-form-item>
              <el-form-item class="right"  label="用户ID">
                <el-input class="info"  v-model="ruleForm.userid"  size="mini" clearable disabled></el-input>
              </el-form-item>
            </div>
            <div class="secondaddition">
              <el-form-item class="left" label="领养类型" >
                <el-radio-group  v-model="ruleForm.adoptype" @change="adoptypetchange" disabled>
...
<script>
  export default {
    ...
    methods: {
      ...
      updateinfo(){
        var that=this;
        var m=this.datesize(this.ruleForm.pubtime,this.getNowFormatDate());
        this.$refs.ruleformpet.validate((valid) => {
          if (valid) {
            if(m==0){
              this.postRequest("/adopt/updateacceptinfo", {
                acceptid:this.ruleForm.acceptid,
