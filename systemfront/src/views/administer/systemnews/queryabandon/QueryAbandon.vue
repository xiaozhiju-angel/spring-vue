          ...
          <div class="middle_top">
            <div class="middle_left">
              <el-form-item class="elformitem" label="发布ID" >
                <el-input  v-model="ruleForm.abandonid"  size="mini" clearable disabled></el-input>
              </el-form-item>
            ...
            <div class="middle_right">
              ...
              <el-button style="margin-top: 30px;margin-left: 35px;color: rosybrown;" type="plain" size="mini">宠物照片</el-button>
              </el-form-item>
            </div>
          </div>
          <div class="middle_bottom">
            ...
            <div class="secondaddition">
              ...
              <el-form-item  class="right"  label="领养类型" prop="adoptype">
                <el-radio-group v-model="ruleForm.adoptype" @change="changeadopt" disabled>
...
<style scoped>
  @import '../../../../../static/css/dialog/queryabandon.css';
  .itemgutter{
    padding: 20px;
    font-size: 14px;
  }
