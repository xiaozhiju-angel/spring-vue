<template>
  <div>
    ...
    <el-dialog class="dialog" :visible.sync="dialogFormVisible">
      <div style="color: #0bbbff;font-size: 16px;margin-bottom: 30px;text-align: center">已登记宠物信息</div>
      <div class="middle">
          ...
          <div class="middle_top">
            ...
            <div class="middle_right">
              <el-form-item>
                ...
                <!--  <img :src="ruleForm.petimageUrl" class="avatar">-->
      ...
      <!--  <el-button type="primary" @click="vaccinrecord()" size="mini">生成疫苗记录</el-button>-->
