<template>
  <div class="middle">
    <div style="padding-top: 20px;font-size: 18px;">添加宠物</div>
    <el-form class="register_message" label-width="100px" ref="ruleformpet" :model="ruleForm" :rules="rulespet">
        ...
        <div class="middle_right">
          <el-form-item>
            <el-upload
              ...
              :on-success="handleAvatarSuccesspet"
      ...
      <div class="middle_bottom">
        ...
        <div class="bottomcenter">
          <el-form-item  class="bottomcenterleft" label="申请登记" prop="petisuserapply">
            <el-radio-group v-model="ruleForm.petisuserapply" @change="applychange" disabled>
              <el-radio class="applyornot" :label="'是'">是</el-radio>
              <el-radio :label="'否'">否</el-radio>
            </el-radio-group>
          </el-form-item>
          <el-form-item class="bottomcenterright" label="登记时间">
            <el-date-picker
              class="datetime"
      ...
      <div class="btn_bottom">
        <el-form-item>
          <el-button class="btn" size="small" type="primary" @click="onSubmitpet()">添 加</el-button>
...
<style scoped>
  @import '../../../../static/css/admin/addpet.css';
</style>
