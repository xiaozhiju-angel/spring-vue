  ...
  <div>
    <table class="table table-hover" style="table-layout: fixed;">
      ...
      <tr v-for="(item,index) in bodyInfoList" :key="index" border>
        ...
        <td  class="opera"><el-button type="primary" size="mini" @click="edit(index)" >更 新</el-button></td>
      </tr>
      </tbody>
    </table>
    ...
    <el-dialog class="dialog" :visible.sync="dialogFormVisible">
      <div style="color: #0bbbff;font-size: 16px;margin-bottom: 20px;text-align: center">更新疫苗信息</div>
      <div class="middle">
        <el-form class="register_message" label-width="100px" ref="ruleform" :model="ruleForm" :rules="rules">
          <div class="middle_top">
            <div class="middle_left">
              <el-form-item  label="疫苗ID" >
                <el-input  v-model="ruleForm.vaccinid"  size="mini" clearable disabled></el-input>
              </el-form-item>
              <el-form-item  label="宠物姓名" prop="petname">
                <el-input v-model="ruleForm.petname" size="mini" clearable disabled></el-input>
              </el-form-item>
            </div>
            <div class="middle_right">
              <el-form-item  label="业主姓名" prop="username">
                <el-input v-model="ruleForm.username" size="mini" clearable disabled></el-input>
              </el-form-item>
              <el-form-item class="right" label="业主性别" prop="usersex">
                <el-radio-group  v-model="ruleForm.usersex" @change="changeusersex" disabled>
          ...
          <div class="middle_bottom">
            ...
            <div class="topaddition">
              <el-form-item class="left" label="宠物性别"  prop="petsex">
                <el-radio-group  v-model="ruleForm.petsex" @change="changepetsex" disabled>
                  <el-radio class="payornot" :label="'公'">公</el-radio>
                  <el-radio :label="'母'">母</el-radio>
                </el-radio-group>
              </el-form-item>
              <el-form-item  class="right" label="业主电话" prop="usertel">
                <el-input v-model="ruleForm.usertel" size="mini" clearable disabled></el-input>
              </el-form-item>
            </div>
            <div class="secondaddition">
              <el-form-item label="宠物类型" class="left" prop="petype">
                <el-select v-model="ruleForm.petype" placeholder="请选择" size="mini" @change="changepet" disabled>
                  <el-option
              ...
              <el-form-item  class="right" label="业主邮箱" prop="useremail">
                <el-input v-model="ruleForm.useremail" size="mini" clearable disabled></el-input>
              </el-form-item>
            </div>
            <div class="bottomtop">
              <el-form-item class="bottomleft" label="上次打疫苗" prop="prevaccin">
                <el-date-picker
                  class="datetime"
  ...
  export default {
    data() {
      return {
        ...
        rules: {
          prevaccin:[{required: true, message: '必填:上次打疫苗时间', trigger: 'blur'}],
        },
      }
    },
    props: {
    ...
    methods: {
      ...
      updateinfo(){
        var that=this;
        var m=this.datesize(this.ruleForm.prevaccin,this.getNowFormatDate());
