<template>
  <div>
    ...
    <QueryLosePub  class="main" :headerList="headerList" :bodyInfoList="bodyInfoList"></QueryLosePub>
  </div>
</template>

<script>
  import QueryLosePub from "./QueryLosePub";
  export default {
    data() {
      return {
        keywords:'',
        ...
        headerList: ",宠物ID,用户ID,宠物姓名,宠物性别,宠物类型,用户姓名,用户电话,发布时间,操作",
        bodyInfoList: [],
      }
    },
    components: {
