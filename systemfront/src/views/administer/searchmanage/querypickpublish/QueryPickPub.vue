  ...
  <div>
    <table class="table table-hover" style="table-layout: fixed;">
      ...
      <tr v-for="(item,index) in bodyInfoList" :key="index" border>
        ...
        <td  class="itemgutter" >{{item.pickuserProp}}</td>
        ...
        <el-form class="register_message" label-width="100px" ref="ruleformpet" :model="ruleForm" :rules="rulespet">
          ...
          <div class="middle_bottom">
            ...
            <div class="secondaddition">
              <el-form-item class="left" label="拾到时间" prop="picktime">
                <el-date-picker
                  class="datetime"
  ...
  export default {
    data() {
      return {
        ...
        rulespet:{
          ...
          picktime:[{required: true, message: '必填:拾到时间', trigger: 'blur'}],
    ...
    methods: {
      ...
      edit(index){
        ...
        this.getRequest("/pick/getpickById?index=" + this.bodyInfoList[index].id).then(resp=> {
          if (resp.data.indexinfo) {
            ...
            _this.ruleForm.userprop=_this.ruleForm[0][0].userprop;
      ...
      clear(index){
        ...
        this.$confirm('此操作将永久删除[' + this.bodyInfoList[index].pickpetuserName + ']发布的这条宠物拾到信息, 是否继续?', '提示', {
