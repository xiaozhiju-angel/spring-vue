<template>
  <div>
    ...
    <QueryPickPub  class="main" :headerList="headerList" :bodyInfoList="bodyInfoList"></QueryPickPub>
  </div>
</template>

<script>
  import QueryPickPub from "./QueryPickPub";
  export default {
    name: "myCare",
    data() {
      return {
        ...
        headerList: ",用户ID,宠物类型,宠物性别,拾到者姓名,拾到者电话,宠物状态,用户角色,发布时间,操作",
        bodyInfoList: [],
      }
    },
    components: {
