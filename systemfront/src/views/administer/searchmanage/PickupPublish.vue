  ...
  <div class="middle">
    ...
    <el-form  class="register_message"  label-width="100px" ref="ruleform" :model="ruleForm" :rules="rules"  >
      ...
      <div class="btn_bottom">
        <el-form-item>
          <el-button class="btn" size="small" type="primary" @click="publishuser()">发布用户拾到</el-button>
          <el-button class="btn" size="small" type="primary" @click="publishstaff()">发布员工拾到</el-button>
          <el-button class="btn" size="small" type="primary" @click="publishadmin()">发布管理员拾到</el-button>
    ...
    data() {
      return {
        ...
        rules:{
          ...
          pubpicktime:[{required: true, message: '必填:发布时间', trigger: 'blur'}],
        },
      };
    },
    methods: {
      ...
      publishuser(){
        ...
        this.$refs.ruleform.validate((valid) => {
          if (valid) {
            if(m==0&&n==0&&k==0){
              this.postRequest("/pick/pickpublishuser",{
      ...
      publishstaff(){
        ...
        this.$refs.ruleform.validate((valid) => {
          if (valid) {
            if(m==0&&n==0&&k==0){
              this.postRequest("/pick/pickpublishstaff",{
                userid:this.ruleForm.userid,
                petsex: this.ruleForm.petsex,
                petype:this.ruleForm.petype,
                petstatus:this.ruleForm.petstatus,
      ...
      publishadmin(){
        ...
        this.$refs.ruleform.validate((valid) => {
          if (valid) {
            if(m==0&&n==0&&k==0){
              this.postRequest("/pick/pickpublishadmin",{
                userid:this.ruleForm.userid,
                petsex: this.ruleForm.petsex,
                petype:this.ruleForm.petype,
                petstatus:this.ruleForm.petstatus,
...
<style scoped>
  @import '../../../../static/css/admin/pickpublish.css';
</style>
