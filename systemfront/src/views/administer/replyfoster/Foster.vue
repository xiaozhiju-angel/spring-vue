<template>
  <div>
    ...
    <QueryApply  class="main" :headerList="headerList" :bodyInfoList="bodyInfoList"></QueryApply>
  </div>
</template>
<script>
  import QueryApply from "./FosterReply";
  export default {
    data() {
      return {
        keywords:'',
    ...
    methods: {
      ...
      searchUserInfo(){
        var _this = this;
        this.getRequest("/foster/getfosterApplyInfoBykeywords?info=" + this.keywords).then(resp=> {
