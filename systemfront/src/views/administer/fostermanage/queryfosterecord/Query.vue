<template>
  <div>
    ...
    <QueryFosterecord  class="main" :headerList="headerList" :bodyInfoList="bodyInfoList"></QueryFosterecord>
  </div>
</template>
<script>
  import QueryFosterecord from "./QueryFosterecord";
  export default {
    data() {
      return {
        keywords:'',
        ...
        headerList: ",宠物ID,用户ID,宠物姓名,宠物性别,宠物类型,开始寄养时间,结束寄养时间,寄养时间,操作",
        bodyInfoList: [],
      }
    },
    components: {
