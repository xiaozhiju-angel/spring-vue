      ...
      <el-header>
        <div  class="header">
          <div class="header_left">
            ...
            <div class="right">
              <div style="margin-left: 5px;font-size: 12px;color:brown;padding-top: 8px">{{adminame}}</div>
          ...
          <div class="header_right">
            ...
            <div class="user">
              <div style="font-size: 14px;text-align: center">{{adminprop}}</div>
              <div style="font-size: 12px;color:brown;text-align: right">ID:<span>{{adminid}}</span></div>
            </div>
            <el-dropdown @command="handleCommand">
              <!--<img  class="usercenter" src="../../../static/homeimg/健康百科-10.png" />-->
              <img  class="usercenter" :src="host+'/'+this.adminimageUrl" alt=""/>
       ...
       <AdminChild  :adminid="adminid"></AdminChild>
    </el-container>
...
<script>
  ...
  import AdminChild from './AdministerHomeChild.vue'
  ...
  export default {
    ...
    methods: {
      ...
      getParams () {
        ...
        var routerParamsadminid=this.$route.query.adminid;
        var name=this.$route.query.adminame;
        var adminimg=this.$route.query.adminimg;
        // 将数据放在当前组件的数据内
        this.adminprop = routerParams;
        this.adminid = routerParamsadminid;
        this.adminame=name;
        this.adminimageUrl=adminimg
      }
    },
    watch: {
...
<style scoped>
  @import "../../../static/css/admin/adminhome.css";
