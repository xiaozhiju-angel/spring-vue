<template>
  <div>
    ...
    <UPetReply  class="main" :headerList="headerList" :bodyInfoList="bodyInfoList"></UPetReply>
  </div>
</template>
<script>
  import UPetReply from "./UPetReply";
  export default {
    data() {
      return {
        keywords:'',
        ...
        headerList: ",宠物ID,姓名,性别,用户ID,宠物类型,上次打疫苗时间,下次打疫苗时间,操作",
        bodyInfoList: [],
      }
    },
    components: {
    ...
    methods: {
      ...
      searchUserInfo(){
        var _this = this;
        this.getRequest("/foster/getRegApplyInfoBykeywords?info=" + this.keywords).then(resp=> {
