<template>
  <div>
    ...
    <QueryPickinfo  class="main" :headerList="headerList" :bodyInfoList="bodyInfoList"></QueryPickinfo>
  </div>
</template>

<script>
  import QueryPickinfo from "./QueryPickinfo";
  export default {
    name: "myCare",
    data() {
      return {
        ...
        headerList: ",用户ID,宠物类型,宠物性别,拾到者姓名,拾到者电话,拾到者邮箱,宠物状态,发布时间,操作",
        bodyInfoList: [],
      }
    },
    components: {
