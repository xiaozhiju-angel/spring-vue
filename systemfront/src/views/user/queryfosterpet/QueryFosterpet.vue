<template>
  <div>
    ...
    <el-dialog class="dialog" :visible.sync="dialogFormVisible">
      <div style="color: #0bbbff;font-size: 16px;margin-bottom: 20px;text-align: center">查看已寄养宠物</div>
      <div class="middle">
        <el-form class="register_message" label-width="100px" ref="ruleformfosterpet" :model="ruleForm" :rules="rulesfosterpet">
          ...
          <div class="middle_bottom">
            ...
            <div class="secondaddition">
              ...
              <el-form-item class="right" label="寄养时间">
                <el-date-picker
                  class="datetime"
  ...
  export default {
    ...
    methods: {
      ...
      del(index){
        ...
        this.$confirm('此操作将删除已寄养的宠物信息, 是否继续?', '提示', {
      ...
      updateinfo(){
        ...
        this.$refs.ruleformfosterpet.validate((valid) => {
          if (valid) {
            var that = this;
            this.postRequest("/foster/queryfosterpet", {
...
<style scoped>
  @import '../../../../static/css/dialog/queryfosterpet.css';
  .itemgutter{
    padding: 25px;
    font-size: 14px;
  }
