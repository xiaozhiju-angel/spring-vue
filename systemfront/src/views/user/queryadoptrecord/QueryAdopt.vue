        ...
        <el-form class="register_message" label-width="100px" ref="ruleformpet" :model="ruleForm" :rules="rulespet">
          <div class="middle_top">
            <div class="middle_left">
              ...
              <el-form-item class="elformitem" label="宠物姓名" >
          ...
          <div class="middle_bottom">
            ...
            <div class="bottomcenter">
              ...
              <el-form-item label="宠物类型" class="right" >
            ...
            <div class="bottombottom">
              <el-form-item class="right" label="领养时间" >
                <el-date-picker
                  class="datetime"
