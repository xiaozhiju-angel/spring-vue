<template>
  <div class="middle">
    <div style="padding-top: 20px;font-size: 18px;">宠物登记申请</div>
    <el-form class="register_message" label-width="100px" ref="ruleformpet" :model="ruleForm" :rules="rulespet">
      ...
      <div class="middle_bottom">
        ...
        <div class="bottomcenter">
          ...
          <el-form-item class="bottomcenterright" label="申请时间">
            <el-date-picker
              class="datetime"
    ...
    methods: {
      ...
      onSubmitpet(){
        ...
        this.$refs.ruleformpet.validate((valid) => {
          if (valid) {
            if(this.ruleForm.petisuserapply=='是'&&m==0&&n==0&&k==0){
              this.postRequest("/pet/applyregpet",{
                ...
                if (response.data.success) {
                  alert(response.data.applyregpet);
                  that.resetFormpet();
                }
                else{
...
<style scoped>
  @import '../../../static/css/user/upetreg.css';
</style>
