  ...
  <div>
    <table class="table table-hover" style="table-layout: fixed;">
      ...
      <tr v-for="(item,index) in bodyInfoList" :key="index" border>
        ...
        <td  class="itemgutter" >{{item.fosterPricescale}}</td>
        <td  class="itemgutter" >{{item.fosterpetallPrice}}</td>
    ...
    <el-dialog class="dialog" :visible.sync="dialogFormVisible">
      <div style="color: #0bbbff;font-size: 16px;margin-bottom: 20px;text-align: center">查看寄养的宠物记录</div>
      <div class="middle">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="dialogFormVisible = false" size="mini">确定</el-button>
