<template>
  <div>
    ...
    <QueryAdmin  class="main" :headerList="headerList" :bodyInfoList="bodyInfoList"></QueryAdmin>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        headerList: ",ID,姓名,身份证号,电话号码,电子邮箱,用户名,操作",
        bodyInfoList: [],
      }
    },
    components: {
    ...
    methods: {
      ...
      searchUserInfo(){
        var _this = this;
        this.getRequest("/admin/getAdminInfoBykeywords?info=" + this.keywords).then(resp=> {
