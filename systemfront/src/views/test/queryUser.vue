  ...
  <div>
    ...
    <el-dialog class="dialog"  :visible.sync="dialogFormVisible">
      <div style="color: #bc2a19;font-size: 14px;margin-bottom: 30px;text-align: center">
        {{ruleForm.username}}<span style="color: dodgerblue">的基本资料</span></div>
      <div class="middle">
      <el-form class="register_message" label-width="100px" ref="ruleformuser" :model="ruleForm" :rules="rulesuser">
        <div class="middle_top">
          ...
          <div class="middle_right">
             <img  class="avatar" :src="host+'/'+ruleForm.userimageUrl" alt=""/>
        ...
        <div class="middle_bottom">
          ...
          <div class="bottomcenter">
            <el-form-item class="bottomcenterleft"  label="身份证号">
          ...
          <div class="bottombottom">
            ...
            <el-form-item class="bottomfooterright" label="注册时间" >
              <el-date-picker
                disabled
                class="datetime"
