<template>
  <div>
    ...
    <QueryTipInfo  class="main" :headerList="headerList" :bodyInfoList="bodyInfoList"></QueryTipInfo>
  </div>
</template>
<script>
  import QueryTipInfo from "./QueryTipInfo";
  export default {
    data() {
      return {
        keywords:'',
        ...
        headerList: ",用户ID,用户姓名,电话号码,发生时间,发生地点,投诉时间,操作",
        bodyInfoList: [],
      }
    },
    components: {
    ...
    methods: {
      ...
      searchUserInfo(){
        var _this = this;
        this.getRequest("/user/querytip?info=" + this.keywords).then(resp=> {
